...
import ru.fes.dao.common.FilterParam;
    ...
    public CommonFilter(Object filter) {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                ru.fes.dao.anno.FilterParam filterParamAnno = field.getAnnotation(ru.fes.dao.anno.FilterParam.class); // берем аннотацию с поля
